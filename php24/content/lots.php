...
?>
		...
		<h1>Product Category: <?php echo $category->getCat_name(); ?>
			<a class="button" 
  			href="index.php?content=lotmaint&cat_id=<?php echo $cat_id_in; ?>&lot_id=0"> Add</a>
		</h1>
		...
		<ul class="ulfancy">
			...
			<li class="row<?php echo $i % 2; ?>">					
				<div class="list-photo">
  				...
  				if (!is_file($image_t)) :  $image_t = 'images/thumbnails/nophoto.jpg';
  				endif;
	...
	<div class="list-description">
    	...
    	<a class="button edit" 
		href="index.php?content=lotdelete&cat_id=<?php echo $cat_id_in; ?>
			&lot_id=<?php echo $lot->getLot_id(); ?>">Delete</a>
    	<a class="button edit" 
		href="index.php?content=lotmaint&cat_id=<?php echo $cat_id_in; ?>
			&lot_id=<?php echo $lot->getLot_id(); ?>">Edit</a></p>
	</div> 
